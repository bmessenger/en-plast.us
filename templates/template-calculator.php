...
<?php get_template_part('templates/page', 'header'); ?>
  <div class="content-wrap">
    <div class="container">
        ...
        <p class="lead green-txt mb-5">ShockDrain is a shock attenuation and synthetic aggregate technology designed for the use beneath synthetic turf designed to achieve optimum advanced artificial athlete performance. Additionally, this pad-based technology delivers high fluid and air transmissivity and low thermal gradient between sub-grade and turf. This design calculator focuses on the drainage performance of ShockDrain in sports field applications. Please refer to "Shock Drain Design Procedures" for the technical background and details on the Input Parameters and design steps performed to determine the drainage capacity, and time to drain. In such applications, a typical section consists of (from top down): Turf & fill cover layer, ShockDrain 580, 6-inch leveling stone, a separation geotextile layer, and finally the prepared subgrade. See Figure 1 for further reference.</p>
        ...
        <p>This design calculator focuses on the drainage performance of ShockDrain in sportfield applications. Please refer to "<a href="https://en-plast.us/wp-content/uploads/2021/11/ShockDrain_Design_Procedures.pdf" target="_blank">Shock Drain Design Procedures</a>" for the technical background and details on the Input Parameters and design steps performed to determine the drainage capacity, and time to drain.</p>
        <p>In such application, a typical section consists of, from top down, turf & fill cover layer, ShockDrain 580, 6-inch leveling stone, a separation geotextile layer, and then the prepared subgrade, see Figure 1.</p>
        
        <img src="/wp-content/uploads/2021/11/sports-field-section-shockdrain580.png" class="img-fluid">
